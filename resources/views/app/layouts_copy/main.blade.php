...
<link rel="stylesheet" href="{{ url('assets/fonts/fontawesome/css/fontawesome-all.min.css') }}">
<link rel="stylesheet" href="{{ url('assets/fonts/material/css/materialdesignicons.min.css') }}">
<link rel="stylesheet" href="{{ url('assets/plugins/animation/css/animate.min.css') }}">
<link rel="stylesheet" href="{{ url('assets/plugins/prism/css/prism.min.css') }}">
...
<link rel="stylesheet" href="{{ url('assets/css/layouts/layout-4.css') }}">
...
<body class="layout-4">
    <div class="wrapper">
        ...
        @include('app.layouts_copy.header')

        @include('app.layouts_copy.sidebar')
      ...
      <p class="font-14">Hello, {{ auth()->user()->name }}. Welcome to Dashboard</p>
                            ...
                            @include('app.layouts_copy.footer')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Float Chart js -->
    <script src="{{ url('assets/plugins/flot/js/jquery.flot.js') }}"></script>
    <script src="{{ url('assets/plugins/flot/js/jquery.flot.categories.js') }}"></script>
    <script src="{{ url('assets/plugins/flot/js/curvedLines.js') }}"></script>
    <script src="{{ url('assets/plugins/flot/js/jquery.flot.tooltip.min.js') }}"></script>

    <!-- peity chart js -->
    <script src="{{ url('assets/plugins/chart-peity/js/jquery.peity.min.js') }}"></script>

    <!-- Rating Js -->
    <script src="{{ url('assets/plugins/ratting/js/jquery.barrating.min.js') }}"></script>
